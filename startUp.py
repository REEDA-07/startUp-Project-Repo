...
st.markdown("<h1 style = 'color: #FC819E; text-align: center; font-family: geneva'>STARTUP PROFIT PREDICTOR</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #F7418F; text-align: center; font-family: cursive '>Built By Gomycode Data Science Daintree Cohort</h4>", unsafe_allow_html = True)
